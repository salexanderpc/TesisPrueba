...
class ImgSolicitudDiagnostico
{
     ...
     *
     * @param \Minsal\PrototipoBundle\Entity\ImgEstudioPaciente $idEstudioPaciente
     * @return ImgSolicitudDiagnostico
     */
    public function setIdEstudioPaciente(\Minsal\PrototipoBundle\Entity\ImgEstudioPaciente $idEstudioPaciente = null)
    {
     ...
     *
     * @param \Minsal\PrototipoBundle\Entity\CtlEstablecimiento $idEstablecimientoSolicitado
     * @return ImgSolicitudDiagnostico
     */
    public function setIdEstablecimientoSolicitado(\Minsal\PrototipoBundle\Entity\CtlEstablecimiento $idEstablecimientoSolicitado = null)
    {
