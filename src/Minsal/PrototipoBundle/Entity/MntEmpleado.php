 ...
 * MntEmpleado
 *
 * @ORM\Table(name="mnt_empleado", indexes={@ORM\Index(name="IDX_2138DDC97DFA12F6", columns={"id_establecimiento"}), @ORM\Index(name="IDX_2138DDC9B13434FE", columns={"id_tipo_empleado"})})
 * @ORM\Entity
 */
class MntEmpleado
{
     ...
     * @var integer
     *
     * @ORM\Column(name="id_cargo_empleado", type="integer", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="id_area_laboratorio", type="string", length=4, nullable=true)
     */
     ...
     *
     * @param string $idAreaLaboratorio
     * @return MntEmpleado
     */
    public function setIdAreaLaboratorio($idAreaLaboratorio)
    {
     ...
     * Set idTipoEmpleado
     *
     * @param \Minsal\PrototipoBundle\Entity\MntTipoEmpleado $idTipoEmpleado
     * @return MntEmpleado
     */
    public function setIdTipoEmpleado(\Minsal\PrototipoBundle\Entity\MntTipoEmpleado $idTipoEmpleado = null)
    {
     ...
     * Get idTipoEmpleado
     *
     * @return \Minsal\PrototipoBundle\Entity\MntTipoEmpleado 
     */
