...
class CtlDepartamento
{
     ...
     *
     * @param \Minsal\PrototipoBundle\Entity\CtlEstablecimiento $idEstablecimientoRegion
     * @return CtlDepartamento
     */
    public function setIdEstablecimientoRegion(\Minsal\PrototipoBundle\Entity\CtlEstablecimiento $idEstablecimientoRegion = null)
    {
     ...
     * Set idPais
     *
     * @param \Minsal\PrototipoBundle\Entity\CtlPais $idPais
     * @return CtlDepartamento
     */
    public function setIdPais(\Minsal\PrototipoBundle\Entity\CtlPais $idPais = null)
    {
        $this->idPais = $idPais;
