...
class CtlDepartamento
{
     ...
     *
     * @param \Minsal\SimagdBundle\Entity\CtlEstablecimiento $idEstablecimientoRegion
     * @return CtlDepartamento
     */
    public function setIdEstablecimientoRegion(\Minsal\SimagdBundle\Entity\CtlEstablecimiento $idEstablecimientoRegion = null)
    {
     ...
     * Set idPais
     *
     * @param \Minsal\SimagdBundle\Entity\CtlPais $idPais
     * @return CtlDepartamento
     */
    public function setIdPais(\Minsal\SimagdBundle\Entity\CtlPais $idPais = null)
    {
        $this->idPais = $idPais;
